    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="data-form" class="pl-3 pr-3">
          <div class="row">
            <input type="hidden" id="id_jabatan" name="id_jabatan" class="form-control" placeholder="Id jabatan" maxlength="4" required>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="jabatan" class="col-form-label"> Jabatan: <span class="text-danger">*</span> </label>
                <input type="text" id="jabatan" name="jabatan" class="form-control" placeholder="Jabatan" minlength="0" maxlength="255" required>
              </div>
            </div>
          </div>
...
<script>
  ...
  function save(id_jabatan) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof id_jabatan === 'undefined' || id_jabatan < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          $("#data-form #id_jabatan").val(response.id_jabatan);
